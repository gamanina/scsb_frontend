 ...
 */
@Entity
@Table(name = "SCSB_SHEET_APPROVAL")
public class SheetApproval
{
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "id_seq")
	@SequenceGenerator(name = "id_seq", sequenceName = "SCSB_SHEET_APPROVAL_ID_SEQ", allocationSize = 1)
	private int id;
