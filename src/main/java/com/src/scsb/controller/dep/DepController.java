package com.src.scsb.controller.dep;
...
public class DepController 
{
	...
	public String digit(Model model, HttpServletRequest request) 
	{
		...
		List<Sheet> bannerList = sheetService.getPassedListByType(now, Constants.DEPOSIT_BANNER_SHEET_TYPE);
		List<Sheet> adList = sheetService.getPassedListByType(now, Constants.DEPOSIT_AD_SHEET_TYPE);
